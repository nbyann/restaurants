  ...
  <section class="container">
    ...
    <div class="restaurant-hero">
      ...
      <div class="restaurant-info">
        ...
        <div class="restaurant-logo"><img src="{{asset('vendor/fogo.jpg')}}" alt=""></div>
    ...
    <div class="main-content">
      ...
      <div class="menu-content">
        ...
        <div class="dishes" id="dishesContainer">
          ...
          <div class="dish-card" data-name="Picanha Grillee(specialite)">

            <div class="dish-image"><img src="{{asset('vendor/steak.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Morceau de boeufs bresilien tres tendre ,grille au feu de bois <br> servi chaud et decoupe directement a table pour garder tout 
            </div>
          ...
          <div class="dish-card" data-name="Steak Premium">

            <div class="dish-image"><img src="{{asset('vendor/steak2.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                steak de boeuf grille ,croustillant a l'exterieur et juteux a l'interieur <br>servi avec sauce et accompagnement au choix  .
              </div>
          ...
          <div class="dish-card" data-name="Poulet Grille">

            <div class="dish-image"><img src="{{asset('vendor/poulet.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Poulet marine aux epices et grille lentement .
              </div>
          ...
          <div class="dish-card" data-name="Cotelletes d'Agneaux">

            <div class="dish-image"><img src="{{asset('vendor/cotellete.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Viande d'agneau savoureuse grillee au feu ,texture douce avec <br> un gout riche et legerement fume.
              </div>
