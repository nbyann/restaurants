  ...
  <section class="container">
    ...
    <div class="restaurant-hero">
      ...
      <div class="restaurant-info">
        ...
        <div class="restaurant-logo"><img src="{{asset('vendor/tagidor.png')}}" alt=""></div>
    ...
    <div class="main-content">
      ...
      <div class="menu-content">
        ...
        <div class="dishes" id="dishesContainer">
          ...
          <div class="dish-card" data-name="Spaghetti Bolognaise">

            <div class="dish-image"><img src="{{asset('vendor/spaghetti.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Pates servies sauce tomate riche et viande hachee savoureuse
              </div>
          ...
          <div class="dish-card" data-name="Crevettes Sautees">

            <div class="dish-image"><img src="{{asset('vendor/crevette.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Crevettes assaisonees sautees a l'ail avec epices parfumees .
              </div>
          ...
          <div class="dish-card" data-name="NDOLE(manioc+plantain frit)">

            <div class="dish-image"><img src="{{asset('vendor/ndole.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Feuille de ndole cuisinees avec arachide,servies avec plantains murs dorees.
              </div>
          ...
          <div class="dish-card" data-name="KOKI+Plantain mur">

            <div class="dish-image"><img src="{{asset('vendor/koki.jpg')}}" alt="image introuvable"></div>
            ...
            <div class="dish-info">
              ...
              <div class="dish-description">
                Gateau de haricots ecrasses et cuits a la vapeur accompagne <br> de plantains murs.
              </div>
